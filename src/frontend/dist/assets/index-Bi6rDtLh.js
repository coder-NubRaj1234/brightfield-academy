...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal-left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-gold font-semibold uppercase tracking-widest text-sm mb-3", children: "Our Story" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-bold text-school-navy uppercase mb-6 leading-tight", children: [
        "Shaping Futures,",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-school-gold", children: "Building Character" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-muted leading-relaxed mb-4", children: "Established in 1998, Bright Future Senior Secondary School has been a beacon of quality education in the heart of New Delhi. Our CBSE-affiliated institution combines rigorous academics with values-based character development." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-muted leading-relaxed mb-6", children: "We believe every child possesses unique potential. Our dedicated faculty of over 120 teachers work tirelessly to identify and nurture that potential, preparing students not just for examinations, but for life's greater challenges." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 mb-8", children: [
        ...
        "li",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 rounded-full bg-school-gold/20 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-school-gold" }) }),
            item
          ]
        },
        item
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal-right", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-6 -left-6 bg-school-gold text-white p-5 rounded-xl shadow-xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-bold", children: "25+" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold uppercase tracking-wide", children: "Years of Excellence" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4 mt-12", children: stats.map(({ label, value, suffix: suffix2, icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "text-center bg-school-lightgray rounded-xl p-4",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 22, className: "text-school-gold mx-auto mb-2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-school-navy", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedCounter, { target: value, suffix: suffix2 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-school-muted font-medium uppercase tracking-wide", children: label })
          ]
        },
        label
      )) })
...
function Contact() {
  ...
  const inputClass = (field) => `w-full border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 transition-colors ${touched[field] && errors[field] ? "border-red-400 focus:ring-red-300 bg-red-50" : touched[field] && !errors[field] ? "border-green-400 focus:ring-green-300 bg-green-50" : "border-gray-200 focus:ring-school-navy/30"}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-gold font-semibold uppercase tracking-widest text-sm mb-2", children: "Contact Us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold uppercase text-school-navy", children: "Get In Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-muted mt-3 max-w-xl mx-auto text-sm", children: "We'd love to hear from you. Send us a message and we'll respond as soon as possible." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal-left", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          "data-ocid": "contact.success_state",
          className: "h-full flex flex-col items-center justify-center py-16 text-center",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 64, className: "text-green-500 mb-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-school-navy mb-2", children: "Message Sent!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-muted text-sm", children: "Thank you for contacting us. We'll get back to you within 24 hours." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  submitting ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-spin-loader inline-block w-4 h-4 border-2 border-white border-t-transparent rounded-full" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { size: 16 }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal-right space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-school-lightgray rounded-2xl p-8 space-y-6", children: [
          {
            icon: MapPin,
            label: "Our Address",
        ...
        ].map(({ icon: Icon2, label, value }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-school-navy rounded-xl flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 20, className: "text-school-gold" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-wide text-school-muted mb-1", children: label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-school-text font-medium whitespace-pre-line", children: value })
          ] })
        ] }, label)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-school-lightgray rounded-2xl overflow-hidden h-48 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 32, className: "text-school-navy mx-auto mb-2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-school-muted font-medium", children: "Delhi – 110054, India" })
        ] }) })
      ] })
    ] })
  ] }) });
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-school-navy text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-sm tracking-wide", children: "BRIGHT FUTURE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-school-gold text-xs tracking-widest", children: "SR. SEC. SCHOOL" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-sm leading-relaxed", children: "Nurturing excellence since 1998. Providing quality education that shapes leaders of tomorrow." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold uppercase tracking-widest text-xs mb-4 text-school-gold", children: "Quick Links" }),
        ...
        ].map(({ label, id }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-school-gold/40", children: "›" }),
              " ",
              label
            ]
          }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold uppercase tracking-widest text-xs mb-4 text-school-gold", children: "Academics" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: [
          "Primary School (I–V)",
          ...
          "Commerce Stream",
          "Humanities Stream"
        ].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-white/60 flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { size: 12, className: "text-school-gold/60" }),
          " ",
          item
        ] }) }, item)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold uppercase tracking-widest text-xs mb-4 text-school-gold", children: "Contact Info" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-sm text-white/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "14, Nehru Vihar, Timarpur,",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Delhi – 110054"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "📞 +91 11 2345 6789" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "📧 info@brightfuture.edu" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "⏰ Mon–Sat: 8:00 AM – 4:00 PM" })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/40 text-xs", children: [
        "© ",
        year,
        " Bright Future Senior Secondary School. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/40 text-xs", children: [
        "Built with ❤️ using",
        " ",
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        backgroundImage: "url('/assets/generated/school-hero.dim_1920x1080.jpg')",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center text-white px-4 max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-gold font-semibold uppercase tracking-[0.3em] text-sm sm:text-base mb-4", children: "Welcome to Excellence in Education" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "h1",
                {
                  ...
                  children: [
                    "BRIGHT FUTURE",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-school-gold", children: "SENIOR SECONDARY SCHOOL" })
                  ]
                }
              )
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg sm:text-xl text-gray-200 mb-8 max-w-2xl mx-auto leading-relaxed", children: "Nurturing young minds to become tomorrow's leaders through academic excellence, character development, and holistic education since 1998." })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `flex flex-col sm:flex-row gap-4 justify-center transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-white/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-12 bg-white/30 animate-pulse" }),
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "nav",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "bg-white shadow-md py-2" : "bg-white/95 py-3"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-school-navy font-bold text-sm sm:text-base tracking-wide leading-none", children: "BRIGHT FUTURE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-school-gold text-xs font-medium tracking-widest", children: "SENIOR SECONDARY SCHOOL" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:flex items-center gap-6", children: [
            navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `text-sm font-semibold uppercase tracking-wide transition-colors duration-200 ${activeSection === link.href.replace("#", "") ? "text-school-gold border-b-2 border-school-gold pb-0.5" : "text-school-navy hover:text-school-gold"}`,
                children: link.label
              },
              link.href
            )),
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden bg-white border-t border-gray-100 shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col py-2", children: [
          navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              onClick: () => scrollTo(link.href),
              className: `text-left px-6 py-3 text-sm font-semibold uppercase tracking-wide transition-colors ${activeSection === link.href.replace("#", "") ? "text-school-gold bg-school-lightgray" : "text-school-navy hover:text-school-gold hover:bg-school-lightgray"}`,
              children: link.label
            },
            link.href
          )),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
...
const notices = [
  {
    id: 1,
    title: "Annual Sports Day – March 15, 2026 | All students must report by 8:00 AM",
    date: "Mar 10, 2026",
    isNew: true,
    category: "Sports"
  },
  ...
  {
    id: 3,
    title: "Parent-Teacher Meeting scheduled for March 22 – Attendance Mandatory",
    date: "Mar 6, 2026",
    isNew: true,
    category: "Academic"
  },
...
function NoticeBoard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "notices", className: "bg-school-lightgray py-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-school-navy text-white py-2 overflow-hidden flex items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0 bg-school-gold px-4 py-2 font-bold text-sm uppercase tracking-widest flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { size: 14 }),
        "Live"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-ticker inline-block", children: notices.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mx-8 text-sm", children: [
        "📢 ",
        n.title
      ] }, n.id)) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 pt-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8 reveal", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-gold font-semibold uppercase tracking-widest text-sm mb-2", children: "Stay Informed" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold uppercase text-school-navy", children: "Important Notices" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 justify-center mb-8 reveal", children: categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          "data-ocid": `notices.${cat.toLowerCase()}.tab`,
          onClick: () => setActiveCategory(cat),
          className: `px-4 py-1.5 rounded-full text-sm font-semibold uppercase tracking-wide transition-all duration-200 ${activeCategory === cat ? "bg-school-navy text-white shadow-md" : "bg-white text-school-navy border border-school-navy/20 hover:border-school-navy"}`,
          children: cat
        },
        cat
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: filtered.map((notice, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-10 h-10 bg-school-navy/10 rounded-lg flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { size: 18, className: "text-school-navy" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 mb-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-school-text text-sm leading-snug", children: notice.title }),
                    notice.isNew && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full", children: "New" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-xs text-school-muted", children: [
...
function Results() {
  const [form, setForm] = reactExports.useState({ name: "", cls: "", section: "" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 reveal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-gold font-semibold uppercase tracking-widest text-sm mb-2", children: "Academic Results" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold uppercase text-white", children: "Check Your Result" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 mt-3 text-sm", children: "Enter your details below to view your result marksheet" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-2xl p-8 reveal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "form",
            {
              ...
              children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "select",
                    {
                      ...
                      children: [
                        ...
                        Array.from({ length: 12 }, (_, i) => i + 1).map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: String(c), children: [
                          "Class ",
                          c
                        ] }, c))
                      ]
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "select",
                    {
                      ...
                      required: true,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Select Section" }),
                        ["A", "B", "C", "D"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: s, children: [
                          "Section ",
                          s
                        ] }, s))
                      ]
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sm:col-span-3 flex justify-center pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 16, className: "animate-spin-loader" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 16 }),
          ...
          loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "results.loading_state", className: "text-center py-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              LoaderCircle,
              {
                size: 36,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-muted text-sm", children: "Fetching your result..." })
          ] }),
          result === "not-found" && !loading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-ocid": "results.error_state",
              className: "text-center py-8 border-t border-gray-100",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { size: 48, className: "text-red-400 mx-auto mb-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-600 font-semibold", children: "Student not found" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-muted text-sm mt-1", children: "Please check the name, class, and section and try again." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-school-muted mt-3", children: 'Try: "Rahul Sharma" / Class 10 / Section A' })
              ]
            }
          ),
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-green-50 text-green-700 px-4 py-2 rounded-full mb-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 16 }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold", children: "Result Found" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-school-navy/10 rounded-xl p-5 bg-school-lightgray", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-muted text-xs uppercase tracking-wide", children: "Student Name" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-school-navy", children: result.name })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-muted text-xs uppercase tracking-wide", children: "Roll No." }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-school-navy", children: result.rollNo })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-muted text-xs uppercase tracking-wide", children: "Class" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-bold text-school-navy", children: [
                          "Class ",
                          result.cls,
                          " – Section ",
                          result.section
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-muted text-xs uppercase tracking-wide", children: "Status" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-school-navy text-white", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 font-semibold text-xs uppercase tracking-wide", children: "Subject" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center px-4 py-3 font-semibold text-xs uppercase tracking-wide", children: "Max Marks" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center px-4 py-3 font-semibold text-xs uppercase tracking-wide", children: "Obtained" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center px-4 py-3 font-semibold text-xs uppercase tracking-wide", children: "Grade" })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
                      result.subjects.map((s, i) => {
                        ...
                        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "tr",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium text-school-text", children: s.subject }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-center text-school-muted", children: s.maxMarks }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-center font-semibold text-school-navy", children: s.obtainedMarks }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "td",
                                {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-school-gold/10 font-bold", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-school-navy", children: "Total" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-center text-school-navy", children: totals.max }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-center text-school-navy", children: totals.obtained }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 text-center text-school-gold", children: [
                          percentage,
                          "%"
                        ] })
                      ] })
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 px-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-school-muted mb-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Percentage" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-school-navy", children: [
                        percentage,
                        "%"
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 bg-gray-100 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          width: `${percentage}%`,
                          background: Number(percentage) >= 75 ? "#16a34a" : Number(percentage) >= 45 ? "#C8A14B" : "#dc2626"
                        }
                      }
                    ) })
                  ] })
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-school-navy p-6 text-white text-center relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold", children: teacher.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-gold font-medium text-sm mt-1", children: teacher.subject })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-muted text-sm leading-relaxed", children: teacher.bio }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-school-muted font-medium uppercase tracking-wide", children: label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-school-text font-medium", children: value })
                ] })
              ] }, label)) })
            ] })
          ]
...
function Teachers() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "teachers", className: "py-20 bg-school-lightgray", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 reveal", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-gold font-semibold uppercase tracking-widest text-sm mb-2", children: "Our Faculty" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold uppercase text-school-navy", children: "Meet Our Educators" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-muted mt-3 max-w-xl mx-auto text-sm", children: "Our team of dedicated professionals brings decades of expertise and genuine passion to every classroom." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6", children: teachers.map((teacher, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden h-48 sm:h-52", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: teacher.photo,
                alt: teacher.name,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-school-text text-sm leading-tight mb-1", children: teacher.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-school-muted text-xs", children: teacher.subject }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-2 inline-block text-xs bg-school-navy/5 text-school-navy px-2 py-0.5 rounded-full font-medium", children: teacher.faculty })
            ] })
          ]
        },
        teacher.id
    ...
    selected && /* @__PURE__ */ jsxRuntimeExports.jsx(TeacherModal, { teacher: selected, onClose: () => setSelected(null) })
  ] });
}
function App() {
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-poppins", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(NoticeBoard, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(About, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Teachers, {}),
